...
namespace ProjectsERB
{
    public partial class addUsers : Form
    {
        ...
        private void getall()
        {
            ...
            dataGridView1.DataSource = context.login_checks.Where(pc=>pc.logincheck_type==1).Select(iv=>new { iv.ID,Name =iv.logincheck_name,UserName=iv.logincheck_username,Password=iv.logincheck_password}).ToList();
        }
