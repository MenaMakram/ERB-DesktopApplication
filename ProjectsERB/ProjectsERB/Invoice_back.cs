...
namespace ProjectsERB
{
    public partial class Invoice_Backs : Form
    {
        ...
        {
            var invoice_type_id = context.invoiceTypePrices.ToList();
        ...
        {
            var morad = context.person.Where(p => p.PersonType_ID == 3).ToList();
        ...
        void calculateTotalBill()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count-1; i++)
            {
                ...
                {
                    price = prd.PriceOutAll;
                }
                else
                {
                    price = prd.PriceOutOne;
            ...
            if (dataGridView2.SelectedRows.Count >= 1 && dataGridView2.Rows.Count > 1)
            {
                ...
                if (check_availableproducts(invid))
                {
                    ...
                    if (invoice.PaymentType_ID == 1)
                    {
                        ...
                        invoice.Person.AccountMoney += invoice.TotalCash;
                        context.SaveChanges();
                    ...
                    else
                    {
                        ...
                        rs.Person.AccountMoney += rs.ResetMoney;
                        context.invoice_products.RemoveRange(ips);
