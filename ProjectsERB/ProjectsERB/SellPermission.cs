                ...
                if (textBox1.Text != "")
                {
                    ...
                    if (prds != null)
                    {
                        if (numericUpDown1.Value > 0)
                        {
                            ...
                            var prodin3 = context.invoice_products.Where(iv => iv.SerialNumber == textBox1.Text && iv.Product_ID == prodsids && iv.Invoice.InvoiceType_ID == 6).Sum(vs => (int?)vs.Quantity) ?? 0;
                            ...
                            var totalfound = ((prodin-prodout1)+prodin2+prodin3)-prodout3;
